...
const music=document.getElementById("music"), musicBtn=document.getElementById("musicBtn"), openBtn=document.getElementById("openBtn"), opening=document.getElementById("opening");
